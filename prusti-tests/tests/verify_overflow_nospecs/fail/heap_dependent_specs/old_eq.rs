...
/*#[pure]*/
fn equal_points3(a: Point, b: Point) -> bool {  // ERRXR: pure function parameters must be Copy
    a == b
}
...
impl Point {
    ...
    /*#[ensures(equal_points3(old(self), result))]*/    // ERRXR: pure function parameters must be Copy
